...
local function vgcrash()
    ...
    repeat
        wait()
    until lp.Backpack:WaitForChild("VampireVanquisher")
...
addcmd(
    {
        ...
        Func = function()
            ...
            repeat
                wait()
            until lp.Backpack:WaitChild("PortableJustice")
...
addcmd(
    {
        ...
        Func = function()
            ...
            rkicker =
                RunService.RenderStepped:Connect(function()
                    char.CFrame =
                        plr.Character.HumanoidRootPart.CFrame * CFrame.Angles(0, math.rad(180), 0) *
                        CFrame.new(0, 0, -2)
...
addcmd(
    {
        -- idk when im finishing dis to lazy
        Name = "k2",
        Func = function()
            local plr = args[2]
            getplayer(plr)
...
addcmd(
    {
        -- this just unloads the commands :D
        Name = "unloadscript",
        Func = function()
...
task.spawn(function()
        if game:IsLoaded() then
            chat(
                "h \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n Mercury🪐 " ..
                    version .. " Loaded in " .. math.floor((tick() - time) * 1000) .. " ms"
            )
