...
addcmd({  --- i know this doesnt work.
    Name = "anticrash",
    Func = function()
        game.Players.Backpack.ChildAdded:Connect(function(v)
...
addcmd({ -- finishing soon
    ...
    Func = function()
        local plr = args[2]
        getplayer(plr)
      connections["_Autoheal "..plr.Name] = RunService.RenderStepped:Connect(function()
...
addcmd({
    ...
    Func = function()
        local plr = args[2]
        getplayer(plr)
        connections["_Antipunish "..plr.Name] = RunService.RenderStepped:Connect(function()
...
addcmd({
    ...
    Func = function()
        local plr = args[2]
            getplayer(plr)
           connections["_Lock "..plr.Name] = plr.CharacterAdded:Connect(function(c)
            wait()
...
addcmd({
    ...
    Func = function()
        local plr = args[2]
        getplayer(plr)
      connections["_Autogod "..plr.Name] = RunService.Hearbeat:Connect(function()
